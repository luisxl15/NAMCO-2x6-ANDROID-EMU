...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "friends.explain" to "Link Discord to show what you're playing and see which friends are in Namco System 246 EMU. Uses your existing Discord friends — Namco System 246 EMU keeps no account and runs no server. Only while the app is open.",
    ...
    "friends.playingNow" to "In Namco System 246 EMU now",
    "friends.nobody" to "None of your Discord friends are in Namco System 246 EMU right now.",
    "friends.notify" to "Notify me in game",
    "friends.notify.desc" to "Show a message over the game when a friend starts playing Namco System 246 EMU.",
    ...
    "about.tagline" to "NAMCO System 246/256 arcade emulation for Android.",
    ...
    "update.checkOnLaunch.desc" to "Automatically check GitHub for a new version each time Namco System 246 EMU starts.",
    ...
    "app.bootLogo.desc" to "Play the Namco System 246 EMU intro video when the app starts.",
    ...
    "games.exit.title" to "Exit Namco System 246 EMU?",
    ...
    "games.quickLoad.confirmBody" to "This copies the disc's files into Namco System 246 EMU's internal storage so the game can load them directly.\n\nSpace needed: about %1\$s\nFree right now: %2\$s\n\nYou can remove them later by holding the entry it creates and choosing Remove quick-load files.",
    ...
    "hotkeys.exitToLauncher.description" to "When a game was launched from another app (e.g. ES-DE), Close Game returns to that app instead of the Namco System 246 EMU library.",
    ...
    "memcard.delete.body" to "Remove \"%s\" from Namco System 246 EMU?\n\nThis deletes the card that Namco System 246 EMU keeps in its own memory-card folder. If you imported it from a file on your device, that original file is not touched.",
    ...
    "overlay.osdSize.description" to "Size of the on-screen display drawn over the game — FPS, stats and notifications. Does not affect the app's menus. 100% = PCSX2's default; Namco System 246 EMU ships 65% so it doesn't crowd a handheld screen.",
    ...
    "patches.bundled.header" to "Bundled with Namco System 246 EMU",
    "patches.bundled.explain" to "These ship inside Namco System 246 EMU and are applied to this game automatically — you didn't install them. Ones with no name are always on and can't be switched off individually.",
    ...
    "patches.hostFs.folder" to "host: reads from the \"hostfs\" folder in your Namco System 246 EMU data folder. Put the files a game expects there — for the Biohazard Outbreak quick-load ELF, that is where its data goes.",
    ...
    "perf.fix.gamedbFixes.desc" to "Master switch for the compatibility fixes below, plus the automatic per-game fixes from Namco System 246 EMU's game database. Leave on unless troubleshooting.",
    ...
    "renderer.importTexturePack.bootFirst" to "Boot a game first so Namco System 246 EMU knows the serial.",
    ...
    "setup.step.rom.description" to "Pick one or more folders holding your arcade games. Each game is a .acgame manifest with its payload folder beside it.",
    ...
    "setup.systemDir.intro" to "Namco System 246 EMU stores memory cards, save states, configs, and shader data in app-private storage by default. ",
    ...
    "setup.welcome.heading" to "Welcome to Namco System 246 EMU setup!",
